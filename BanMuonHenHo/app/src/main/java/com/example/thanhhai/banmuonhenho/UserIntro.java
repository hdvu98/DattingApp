...
public class UserIntro {
    ...
    public UserIntro(String selfIntro, Integer relationship, Integer sexuality, Integer height, Integer weight,
                     Integer bodyImage, Integer eyeColor, Integer hairColor, Integer living, Integer drinking, Integer smoking,
                     Integer kid) {
